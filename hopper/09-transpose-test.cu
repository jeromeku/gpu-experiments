...
// Tile width == #banks causes shared memory bank conflicts because
// every element in the same column belongs to the same bank.
...
// Now, all elements in the same column belong to different banks.
